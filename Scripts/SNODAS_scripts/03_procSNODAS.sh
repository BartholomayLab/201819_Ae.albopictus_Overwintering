...
##############################################################################
 ...
 if [ -z "Volumes/Seagate/SNODAS" ]; then
 ...
 genhdr=/Users/kmilsong/Documents/CBS_PhD/albopictus_OW/SNODAS_scripts/generic.hdr

 # Define out directory for .nc files
 odir=/Volumes/Seagate/SNODAS/snowdepth
 mkdir  $odir 
 
 # Define directory with variable subdirs of dat files
 cd /Volumes/Seagate/SNODAS
